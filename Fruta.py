...
class StudentGUI:
    def __init__(self, frame):
        ...
        # background frames
        bg_frame = Frame(self.frame, bg="#800000")
        bg1_frame = Frame(self.frame, bg="#800000")
        bg_frame.place(x=0, y=0, width=1155, height=650)
        bg1_frame.place(x=7.5, y=7.5, width=1140, height=635)

        #  Layout for left frame
        self.left_frame = Frame(bg1_frame, bd=2, bg="#800000")
        self.left_frame.place(x=15, y=80, width=450, height=550)
        self.sis_label = Label(bg1_frame, text="STUDENT INFORMATION SYSTEM", bg="#800000", fg="white")
        ...
        self.add_frame = Frame(self.left_frame, bg="white", highlightbackground="#A51d23", highlightthickness=5)
        self.edit_frame = Frame(self.left_frame, bg="white", highlightbackground="#A51d23", highlightthickness=5)
        self.delete_frame = Frame(self.left_frame, bg="white", highlightbackground="#A51d23", highlightthickness=5)
        self.search_frame = Frame(self.left_frame, bg="white", highlightbackground="#A51d23", highlightthickness=5)

        self.head_bldsgn_img = PhotoImage(file=r"label_design.png")
        self.heading_label = Label(self.left_frame, bg="#A51d23", fg="white", anchor='sw', font=("Monaco", 20))
        self.heading_lbldsgn = Label(self.left_frame, image=self.head_bldsgn_img, bg="#A51d23",
                                     fg="white", anchor='sw', font=("Monaco", 24))
        ...
        # right_frame
        self.right_frame = Frame(bg1_frame, bg="#800000")
        self.right_frame.place(x=465, y=100, width=675, height=600)
        self.display_label = Label(self.right_frame, bg="#A51d23", fg="white", anchor='w', font=("Monaco", 24),)
    ...
    def homepage(self):
        ...
        self.sis_label.config(font=("Monaco", 50), fg="White", borderwidth=3, highlightcolor="Black")
        self.sis_label.pack(anchor=CENTER, pady=30)
        self.heading_label.config(text="   Features")

        self.add_stud_button.place(x=350, y=250, width=125, height=125)
        self.edit_stud_button.place(x=700, y=250, width=125, height=125)
        self.delete_stud_button.place(x=350, y=450, width=125, height=125)
        self.search_stud_button.place(x=700, y=450, width=125, height=125)


    # Display attributes common to different frames
    def display_attributes(self):
        self.sis_label.config(font=("Monaco", 30), fg="white")
        ...
        self.display_lbldsgn.place(x=550, y=25, width=100, height=70)
    ...
    # buttons
        self.add_stud_button.place(x=98, y=100, width=75, height=75)
        self.edit_stud_button.place(x=178, y=100, width=75, height=75)
        self.delete_stud_button.place(x=260, y=100, width=75, height=75)
        self.search_stud_button.place(x=340, y=100, width=75, height=75)
