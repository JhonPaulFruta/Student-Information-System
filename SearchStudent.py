...
class SearchStudentFrame:
    def __init__(self, frame):
        ...
        self.srch_result_msg = Label(self.search_frame, text="", bg="white", fg="#A51d23", font=("Monaco", 10))
        ...
        self.search_frame.place(x=20, y=120, width=500, height=430)
        id_no_label = Label(self.search_frame, text="ID #", bg="#A51d23", fg="white", font=("Monaco", 20))
        id_no_label.place(x=25, y=45, width=55, height=40)
        ...
        search_button = Button(self.search_frame, command=self.search_student,
                               image=self.srch_btn_img, bg="#A51d23", fg="white", font=("Monaco", 20))
