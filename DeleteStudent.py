...
class DeleteStudentFrame:
    def __init__(self, frame, table):
        ...
        self.del_stud_name = Label(self.delete_frame, fg="black", bg="white", highlightthickness=2,
                                    highlightbackground="#885E4B", font=("Monaco", 16), anchor='w')
        ...
        self.del_stud_course = Label(self.delete_frame, fg="black", bg="white",highlightthickness=2,
                                    highlightbackground="#885E4B", font=("Monaco", 16),
                                     anchor='w')
        self.del_stud_gender = Label(self.delete_frame, fg="black", bg="white",highlightthickness=2,
                                    highlightbackground="#885E4B", font=("Monaco", 16),
                                     anchor='w')

        self.delete_frame.place(x=20, y=120, width=510, height=430)
        choose_lbl = Label(self.delete_frame, text="Select Student to Delete", anchor='w', fg="black", bg="white",
                           font=("Monaco", 14))
        
        # GUI for selecting student to be deleted
        choose_lbl.place(x=20, y=30, width=220, height=30)
        choose_stud_btn = Button(self.delete_frame, command=self.select_stud,
                                 text="Select", bg="#A51d23", fg="white", font=("Cambria", 20))
        choose_stud_btn.place(x=280, y=30, width=90, height=30)

        name_label = Label(self.delete_frame, text="Name:", font=("Monaco", 20), bg="#A51d23", fg="white")
        name_label.place(x=20, y=80, width=90, height=40)
        id_no_label = Label(self.delete_frame, text="ID No.:", font=("Monaco", 20), bg="#A51d23", fg="white")
        id_no_label.place(x=20, y=130, width=90, height=40)
        year_label = Label(self.delete_frame, text="Year:", font=("Monaco", 20), bg="#A51d23", fg="white")
        year_label.place(x=20, y=180, width=90, height=40)
        course_label = Label(self.delete_frame, text="Course:", font=("Monaco", 20), bg="#A51d23", fg="white")
        course_label.place(x=20, y=230, width=90, height=40)
        gender_label = Label(self.delete_frame, text="Gender:", font=("Monaco", 20), bg="#A51d23", fg="white")
        ...
        delete_button = Button(self.delete_frame, command=self.delete_student, text="Delete", bg="#A51d23", fg="white",
                               font=("Monaco", 20))
        delete_button.place(x=280, y=350, width=110, height=30)

        self.del_stud_name.place(x=115, y=80, width=20, height=40)
