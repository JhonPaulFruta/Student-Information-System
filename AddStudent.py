...
class AddStudentFrame:
    def __init__(self, frame, table):
        ...
        self.add_id_entry = Entry(self.add_frame, textvariable=self.id_no, highlightthickness=2,
                                  highlightbackground="#A51d23", font=("Monaco", 20))
        self.add_year_combo = ttk.Combobox(self.add_frame, textvariable=self.year, font=("Monaco", 20),
                                           values=[
                                               "1st Year",
                                               "2nd Year",
                                               "3rd Year",
        ...
        self.add_course_entry = Entry(self.add_frame, textvariable=self.course, highlightthickness=2,
                                      highlightbackground="#A51d23", font=("Monaco", 18))
        self.add_gender_combo = ttk.Combobox(self.add_frame, textvariable=self.gender, font=("Monaco", 20),
                                             values=["Male", "Female", "Other"])

        # add_student_interface
        self.add_frame.place(x=20, y=120, width=500, height=430)

        # attributes of the add student feature
        name_label = Label(self.add_frame, text="Name:", font=("Monaco", 20), bg="#A51d23", fg="white")
        name_label.place(x=20, y=50, width=90, height=40)
        self.add_name_entry.place(x=110, y=50, width=270, height=40)
        id_no_label = Label(self.add_frame, text="ID No.:", font=("Monaco", 20), bg="#A51d23", fg="white")
        id_no_label.place(x=20, y=120, width=90, height=40)
        name_format = Label(self.add_frame, text="Last Name, First Name, M.I", font=("Monaco", 10), fg="#A51d23",
                            bg="white")
        name_format.place(x=115, y=91, height=20)
        self.add_id_entry.place(x=110, y=120, width=270, height=40)
        year_label = Label(self.add_frame, text="Year:", font=("Monaco", 20), bg="#A51d23", fg="white")
        year_label.place(x=20, y=170, width=90, height=40)
        self.add_year_combo.place(x=110, y=170, width=270, height=40)
        course_label = Label(self.add_frame, text="Course:", font=("Monaco", 20), bg="#A51d23", fg="white")
        course_label.place(x=20, y=220, width=90, height=40)
        self.add_course_entry.place(x=110, y=220, width=270, height=40)
        gender_label = Label(self.add_frame, text="Gender:", font=("Monaco", 20), bg="#A51d23", fg="white")
